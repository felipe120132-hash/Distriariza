...
const seedDatabase = async () => {
    try {
        ...
        const productos = [
            ...
            { nombre: 'Acuaprime 240ml', desc: 'Eliminador de cloro y metales pesados.', precio: 11500, cat: catLiq.insertId, img: 'acuaprime-240.jpeg' },
            { nombre: 'Acuaprime Litro', desc: 'Eliminador de cloro y metales pesados.', precio: 29000, cat: catLiq.insertId, img: 'acuaprime-litro.jpeg' },
            ...
            { nombre: 'Alga Clear 20ml', desc: 'Evita la propagación de algas causadas por la luz del sol.', precio: 4500, cat: catLiq.insertId, img: 'alga-clear-20.jpeg' },
            { nombre: 'Clarify 20ml', desc: 'Tratamiento para mejorar la claridad del agua.', precio: 3000, cat: catLiq.insertId, img: 'clarify-20.jpeg' },
            { nombre: 'Clarify 60ml', desc: 'Tratamiento para mejorar la claridad del agua.', precio: 6500, cat: catLiq.insertId, img: 'clarify-60.jpeg' },
            ...
            { nombre: 'Tratamiento de agua ICK 30 ml', desc: 'Alivia enfermedades causadas por elpunto blanco.', precio: 1300, cat: catLiq.insertId, img: 'ICK-30.jpeg' },
            { nombre: 'Antialgas', desc: 'Previene la formación de algas en el acuario.', precio: 3000, cat: catLiq.insertId, img: 'antialgas.jpeg' },
