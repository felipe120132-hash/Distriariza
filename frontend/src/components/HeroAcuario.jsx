...
export const HeroAcuario = ({ scrollY = 0 }) => {
  ...
  return (
    <div className="aquarium-hero">
      ...
      <div className="parallax-layer hero-text" style={{ zIndex:20, transform:`translateY(${s * -0.45}px)`, opacity:Math.max(0, 1 - s / 180), willChange:'transform, opacity' }}>
        ...
        <h1 style={{ fontFamily:'var(--font-display)', fontSize:'clamp(2.2rem,5vw,3.5rem)', fontWeight:700, color:'#fff', lineHeight:1.15, textShadow:'0 4px 16px rgba(0,0,0,0.4)' }}>
